...
>
> To keep this simple, I'll cascade a small, easy-to-follow feature on a **personal project I keep around for trying out new tools and techniques**. The feature: **adding the estimated reading time to an article** — the little "3 min read" you see on most blogs or news websites. It's deliberately simple, so the focus stays on the *workflow*, not the code.
>
